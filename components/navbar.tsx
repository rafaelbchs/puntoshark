    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Tops Deportivos", href: "/collections/women/sports-bras" },
          { name: "Leggins", href: "/collections/women/leggings" },
          { name: "Shorts", href: "/collections/women/shorts" },
          { name: "Sudaderas", href: "/collections/women/hoodies-sweatshirts" },
    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Sudaderas", href: "/collections/men/hoodies-sweatshirts" },
    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Gorras", href: "/collections/accessories/hats-caps" },
